    ...
    <div class="row g-4 mb-4">
        <div class="col-lg-8">
            <div class="stat-card shadow-sm d-flex align-items-center gap-4 animate-on-scroll"
                ...
                <div>
                    <h4 class="fw-bold mb-1" style="color: #fff;" id="siswaGreeting">Selamat Datang, {{ $user->name }}!
                    </h4>
                    ...
                    <div class="row g-3">
                        @foreach ($enrolledCourses as $index => $course)
                            <div class="col-md-6 col-lg-4">
                                <div class="card border-0 h-100 animate-on-scroll delay-{{ min($index + 1, 5) }}"
                                    style="border-radius: 14px; background: #f8faff;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                            <div
                                                style="width: 44px; height: 44px; border-radius: 12px; background: linear-gradient(135deg, #4e73df, #224abe); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 1.2rem;">
                                                <i class="fas fa-book"></i>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-muted">
                                                <i
                                                    class="far fa-calendar-alt me-1"></i>{{ $course->created_at->format('d M Y') }}
                                            </small>

                                            <a href="{{ route('siswa.courses.learn', $course->id) }}"
                            ...
                            <tbody>
                                @foreach ($quizAttempts as $index => $attempt)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="score-badge {{ $attempt->certificate_path ? 'score-pass' : 'score-fail' }}">
                                                {{ $attempt->score }}
                                            </span>
                                        </td>
                    ...
                    <div class="cert-card p-4 mb-3">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <a href="{{ asset('storage/' . $cert->certificate_path) }}"
                                class="btn btn-primary btn-download" target="_blank" download>
